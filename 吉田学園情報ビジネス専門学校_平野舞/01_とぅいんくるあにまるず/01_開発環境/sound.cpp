...
CSound::PARAM CSound::m_aParam[SOUND_LABEL_MAX]
{
	...
	{ "data/SE/Attack.wav", 0 },	// プレイヤーダメージ
	{ "data/SE/Skill.wav", 0 },		// スキル
	{ "data/SE/Item.wav", 0 },		// アイテム
	{ "data/SE/Attack.wav", 0 },	// 敵ダメージ
	{ "data/SE/click_cat.wav", 0 },	// 決定_猫
	{ "data/SE/click_dog.wav", 0 },	// 決定_犬
};
...
//-----------------------------------------------------------------------------------------------
CSound::CSound()
	:m_pXAudio2(nullptr), m_pMasteringVoice(nullptr)
{
...
HRESULT CSound::Init(HWND hWnd)
{
	...
	for (int nCntSound = 0; nCntSound < SOUND_LABEL_MAX; nCntSound++)
	{
		...
		// サウンドデータファイルの生成
		hFile = CreateFile(m_aParam[nCntSound].pFileName, GENERIC_READ, FILE_SHARE_READ, nullptr, OPEN_EXISTING, 0, nullptr);
